...
/**
 *  Permet de générer des formulaire plus facilement
 */
class Form {
    ...
    public function input($name, $label, $options = array()) {
        ...
        name="' . $name . '" value="1" ' . (empty($value) ? '' : 'checked') . '>';
            ...
            $html.='<input type="file" class="input-file" name="' . $name . '" name="' . $name . '"' . $attr . '>';
        } elseif ($options['type'] == 'password') {

            $html.='<input type="password" id="input' . $name . '" name="' . $name . '" name="' . $name . '" value="' . $value . '" ' . $attr . '>';
        }
