<div class="page-header">
    <h1>Editer une source</h1>
</div>


<form class="form-horizontal" action ="<?php echo Router::url('admin/sources/edit/' . $id); ?>" method="post">
    <?php echo $this->Form->input('content', 'Contenu : '); ?>
    <?php echo $this->Form->input('id', 'hidden'); ?>
    <?php echo $this->Form->input('type', 'Type( rrs ou lien) : '); ?>
